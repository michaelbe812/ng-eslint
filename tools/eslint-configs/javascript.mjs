...
export default tseslint.config(
  {
    ...
    extends: [
      ...
      {
        name: 'custom/javascript/unused-disable',
        linterOptions: {
          reportUnusedDisableDirectives: 'warn',
        },
      },
      {
        name: 'custom/javascript/customized',
        plugins: {
          unicorn,
        },
        rules: {
      ...
      {
        name: 'custom/javascript/disabled',
        rules: {
      ...
      {
        name: 'custom/javascript/additional',
        plugins: {
          functional,
        },
        rules: {
  ...
  {
    name: 'custom/javascript/tests/disabled',
  ...
  {
    name: 'custom/javascript/tests/customized',
    files: TEST_FILE_PATTERNS,
    rules: {
  ...
  {
    name: 'custom/javascript/mocks/disabled',
  ...
  {
    name: 'custom/javascript/configs/disabled',
  ...
  {
    name: 'custom/javascript/generated/disabled',
  ...
  {
    name: 'custom/javascript/json/disabled',
  ...
  {
    name: 'custom/javascript/cjs/disabled',
  ...
  {
    name: 'custom/javascript/dts/disabled',
  ...
  {
    name: 'custom/javascript/svelte/disabled',
