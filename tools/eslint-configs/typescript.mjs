...
export default tseslint.config(
  ...javascript,
  {
    ...
    extends: [
      ...
      {
        name: 'custom/typescript/customized',
        rules: {
      ...
      {
        name: 'custom/typescript/disabled',
        rules: {
      ...
      {
        name: 'custom/typescript/additional',
        rules: {
  ...
  },
  {
    ...
    extends: [
      {
        name: 'custom/typescript/tests/disabled',
        rules: {
      ...
      {
        name: 'custom/typescript/tests/customized',
        rules: {
          '@typescript-eslint/consistent-type-assertions': [
            'warn',
            {
  ...
  {
    name: 'custom/typescript/storybook/customized',
